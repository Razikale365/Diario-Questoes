    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-end justify-center z-50 p-0 md:items-center md:p-4">
      <div className="bg-[#262626] p-5 w-full min-h-[80vh] border border-[#404040] shadow-2xl rounded-t-3xl md:min-h-0 md:max-w-lg md:rounded-xl md:p-6">
        ...
        <div className="flex justify-end gap-3 flex-wrap">
          <button onClick={onClose} className="min-h-12 px-4 py-2 text-gray-300 hover:text-white hover:bg-[#333333] rounded-lg transition-colors font-medium mr-auto">
            Cancelar
          </button>
          <button 
            onClick={handleMerge} 
            disabled={!text.trim()}
            className="min-h-12 bg-[#404040] hover:bg-[#525252] disabled:opacity-50 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg font-bold transition-colors flex items-center gap-2 border border-[#525252]"
          >
          ...
          <button 
            ...
            disabled={!text.trim()}
            className="min-h-12 bg-[#84cc16] hover:bg-[#65a30d] disabled:opacity-50 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg font-bold transition-colors flex items-center gap-2"
          >
