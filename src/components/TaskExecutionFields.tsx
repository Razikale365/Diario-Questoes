...
const NumericField: React.FC<{
  ...
  <label className="grid min-w-0 gap-1 text-[9px] font-black uppercase tracking-[0.16em] text-gray-500">
    {label}
    <input
      type="text"
      inputMode="numeric"
  ...
  return (
    <fieldset className="border border-white/10 bg-[#171b18] p-3 sm:p-4">
      ...
      <div className="mt-3 grid gap-3 border-t border-white/[0.07] pt-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
        <label className="grid gap-1 text-[9px] font-black uppercase tracking-[0.16em] text-gray-500">
          Observações
        ...
        <div className="flex flex-wrap items-end gap-3">
          <label className="grid gap-1 text-[9px] font-black uppercase tracking-[0.16em] text-gray-500">
            Desempenho derivado
            <input readOnly value={performance} title="Calculado automaticamente a partir de certas e erradas" className="h-10 w-44 border border-[#84cc16]/20 bg-[#84cc16]/10 px-3 text-sm font-black text-[#d9f99d] outline-none" />
          </label>
          <div className="grid gap-1">
            <span className="text-[9px] font-black uppercase tracking-[0.16em] text-gray-500">Energia depois</span>
