...
interface TaskHeaderProps {
  ...
  onPause?: () => void;
  onReopen?: () => void;
  onUpdateAllLayouts?: (layout: { columns: number, rows: number, type: 'grid' | 'columns' }) => void;
  showDate?: boolean;
  showStats?: boolean;
  onToggleStats?: () => void;
}
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
        <div className="flex-1">
          ...
          {onUpdateAllLayouts && task.blocks.length > 0 && (
            <div className="mt-6 pt-4 border-t border-[#404040]/50 flex flex-wrap items-center gap-8 animate-in fade-in slide-in-from-left-4 duration-500 delay-150">
